...
# Load data
metMat <- read.table("HumanMethylation450_TCGA-PANCAN_1000x1000.txt", sep = "\t")   # Methylation data
exprMat <- read.table("HTSeq-FPKM-UQ_TCGA-PANCAN_1000x1000.txt", sep = "\t")        # Expression data
probeinfo <- read.table("Probeinfo.txt", sep = "\t")                                # CpG location file
