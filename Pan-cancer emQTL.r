...
# Load data
metMat <- read.table("/open/tmp/Jorgen/Test_script/HumanMethylation450_TCGA-PANCAN_1000x10000.txt", sep = "\t") # Methylation data
exprMat <- read.table("/open/tmp/Jorgen/Test_script/HTSeq-FPKM-UQ_TCGA-PANCAN_1000x10000.txt", sep = "\t") # Expression data
probeinfo <- read.table("/open/tmp/Jorgen/Test_script/Probeinfo.txt", sep = "\t") # File containing information about CpG location
...
# Load data
metMat <- read.table("HumanMethylation450_TCGA-PANCAN_100x1000.txt", sep = "\t")
exprMat <- read.table("HTSeq-FPKM-UQ_TCGA-PANCAN_100x100.txt", sep = "\t")
